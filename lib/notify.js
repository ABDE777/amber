...
//   Email (SMTP/Nodemailer): EMAIL_HOST      (e.g. smtp.gmail.com)   [or SMTP_HOST]
//                            EMAIL_PORT      (optional, default 587) [or SMTP_PORT]
//                            EMAIL_SECURE    (optional, "true" for port 465) [or SMTP_SECURE]
//                            EMAIL_USER      (SMTP username)         [or SMTP_USER]
//                            EMAIL_PASS      (app password)          [or SMTP_PASS]
//                            ORDER_EMAIL_TO  (admin inbox that receives orders)
//                            ORDER_EMAIL_FROM(optional, defaults to EMAIL_USER;
//                                             for Gmail keep it equal to EMAIL_USER)
...
async function sendEmail(subject, text) {
  // Accept either EMAIL_* or SMTP_* env var names.
