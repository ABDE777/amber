...
export function calculatePrice(qtyInGrams, countryName, isAr = true, ratesOverride = null, basePriceOverride = null) {
  ...
  // Allow callers to inject the live admin price; fall back to the static constant
