...
export const STR = {
  ar: {
    ...
    modal: {
      ...
      payDirect: "طلب مباشر (واتساب / دفع عند الاستلام)",
      payDirectDesc: "تأكيد الطلب يدويًا والتنسيق عبر الواتساب أو الدفع عند الاستلام داخل المغرب",
      cardsAccepted: "البطاقات المعتمدة: Visa · Mastercard · CMI",
      payCardCta: "متابعة للدفع الآمن بالبطاقة",
      payDirectCta: "تأكيد الطلب المباشر",
  ...
  en: {
    ...
    modal: {
      ...
      payMethod: "Payment & Confirmation Method",
      payCard: "Credit / Debit Card (Visa, Mastercard, CMI)",
      payCardDesc: "Instant, 3D-Secure encrypted payment for all Moroccan and international cards (Morocco, Asia, Europe, Americas)",
      payDirect: "Direct Inquiry (WhatsApp / Cash on Delivery)",
      payDirectDesc: "Manual order confirmation via WhatsApp or Cash on Delivery where applicable",
      cardsAccepted: "Accepted: Visa · Mastercard · CMI Bank Cards",
      payCardCta: "Proceed to Secure Card Payment",
      payDirectCta: "Confirm Direct Order",
  ...
  fr: {
    ...
    modal: {
      ...
      payMethod: "Mode de paiement et confirmation",
      ...
      payDirect: "Commande directe (WhatsApp / Paiement à la livraison)",
      payDirectDesc: "Confirmation manuelle par WhatsApp ou paiement à la livraison au Maroc",
      cardsAccepted: "Cartes acceptées : Visa · Mastercard · CMI",
      payCardCta: "Procéder au paiement sécurisé par carte",
      payDirectCta: "Confirmer la commande directe",
